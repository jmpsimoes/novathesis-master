...
\title[Estudo de implementações eficientes em Correlações estatísticas de Expressões Relevantes(ER) em documentos de linguagem natural]{Estudo de implementações eficientes em Correlações estatísticas de Expressões Relevantes(ER) em documentos de linguagem natural}
\subtitle{Science is beautiful}

% Autor
% use [f] for female and [m] for male
\authorname[m]{João Manuel Pinto Simões}{João Simões}
...
% use [f] for female and [m] for male
\adviser[m]{Joaquim Silva}{Professor Auxiliar}{\\& FCT, Universidade Nova de Lisboa} 
...
% use [f] for female and [m] for male
\coadviser[m]{Vitor Duarte}{Professor Auxiliar}{\\& FCT, Universidade Nova de Lisboa}
